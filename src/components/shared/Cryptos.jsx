      ...
      <div className="row">
        <div className="col-12 col-sm-6 col-md-4">
          <div className="card py-3 my-2 mx-3 d-flex flex-row justify-content-evenly align-items-center">
            ...
            <div style={{ fontSize: "1.6vw" }}>
              <h1 style={{ color: "rgb(115 115 115)" }}>LTC</h1>
              <p style={{ fontWeight: 700 }}>0.00000000</p>
            </div>
          </div>
        </div>
        <div className="col-12 col-sm-6 col-md-4">
          <div className="card py-3 my-2 mx-3 d-flex flex-row justify-content-evenly align-items-center">
            ...
            <div style={{ fontSize: "1.6vw" }}>
              <h1 style={{ color: "rgb(115 115 115)" }}>BTC</h1>
              <p style={{ fontWeight: 700 }}>0.00000000</p>
            </div>
          </div>
        </div>
        <div className="col-12 col-sm-6 col-md-4">
          <div className="card py-3 my-2 mx-3 d-flex flex-row justify-content-evenly align-items-center">
            ...
            <div style={{ fontSize: "1.6vw" }}>
              <h1 style={{ color: "rgb(115 115 115)" }}>ETH</h1>
              <p style={{ fontWeight: 700 }}>0.00000000</p>
            </div>
          </div>
        </div>
        <div className="col-12 col-sm-6 col-md-4">
          <div className="card py-3 my-2 mx-3 d-flex flex-row justify-content-evenly align-items-center">
            ...
            <div style={{ fontSize: "1.6vw" }}>
              <h1 style={{ color: "rgb(115 115 115)" }}>TRX</h1>
              <p style={{ fontWeight: 700 }}>0.00000000</p>
            </div>
          </div>
        </div>
        <div className="col-12 col-sm-6 col-md-4">
          <div className="card py-3 my-2 mx-3 d-flex flex-row justify-content-evenly align-items-center">
            ...
            <div style={{ fontSize: "1.6vw" }}>
              <h1 style={{ color: "rgb(115 115 115)" }}>USDC</h1>
              <p style={{ fontWeight: 700 }}>0.00000000</p>
            </div>
          </div>
        </div>
        <div className="col-12 col-sm-6 col-md-4">
          <div className="card py-3 my-2 mx-3 d-flex flex-row justify-content-evenly align-items-center">
            ...
            <div style={{ fontSize: "1.6vw" }}>
              <h1 style={{ color: "rgb(115 115 115)" }}>USDT</h1>
              <p style={{ fontWeight: 700 }}>0.00000000</p>
            </div>
          </div>
        </div>
