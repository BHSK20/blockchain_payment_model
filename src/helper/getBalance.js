...
const INFURA_API_KEY = '7896f3612eca4491bb7a895198929bac'
// Initialize Web3 with Sepolia network's RPC endpoint
...
const tokenContractAddress = '0x7819188be76a23C04Fa416C6B6708a80418b5f9b';
const tokenABI = [
...
async function getTokenBalance(accountAddress) {
    try {
        // Call the balanceOf method of the token contract
...
// Example usage:
const accountAddress = '0xa93976cFB34A7aEDA88fa67fDE8f355C0ada3b7B';
getTokenBalance(accountAddress)
    .then(balance => {
        if (balance !== null) {
            console.log('Token balance:', balance);
            // You can now display the balance in your frontend
        } else {
